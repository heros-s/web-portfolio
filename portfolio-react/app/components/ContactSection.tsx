                ...
                <form className="space-y-4 mt-8">
                    <div>
                        <input
                            ...
                            className="w-full bg-zinc-900 border border-zinc-800 px-4 py-3 rounded-lg text-white focus:outline-none focus:border-cyan-500 transition"
                            required
                        />
                    </div>
                    <div>
                    ...
                    <div>
                        <textarea
                            ...
                            rows={5}
                            className="w-full bg-zinc-900 border border-zinc-800 px-4 py-3 rounded-lg text-white resize-none focus:outline-none focus:border-cyan-500 transition"
                            required
                        ></textarea>
                    </div>
                    <button
